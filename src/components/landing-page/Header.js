    ...
    <div class="header" id="header">
      ...
      <ReactBootstrap.Row lg>
        <ReactBootstrap.Col className="header-title">
          ...
          <p>We help your businesses to do managment inventory easier and also help you to predict the stock of your product in the next few days!</p>
          <ReactBootstrap.Button variant="primary" className="button">Get Started!</ReactBootstrap.Button>
        </ReactBootstrap.Col>
        <ReactBootstrap.Col lg>
            <ReactBootstrap.Image src={HeaderImg} alt="Header Image" className="header-img"/>
        </ReactBootstrap.Col>
      </ReactBootstrap.Row>
    </ReactBootstrap.Container>
    </div>
