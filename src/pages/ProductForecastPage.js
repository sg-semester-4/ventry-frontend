...
import "./Styles/ProductForecastStyle.css";
...
import ProductViewModalComponent from "../components/ProductForecastPage/ProductViewModalComponent";
...
class ProductForecastPage extends Component {
  ...
  render() {
    ...
    return (
      <div className="page product-forecast">
        ...
        <div className="header">
          <div className="left-section">
            ...
            <div className="description">
              <div className="text">
                You can see a forecasting graph detail of your product here.
              </div>
            </div>
          </div>
